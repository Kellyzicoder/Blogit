...
$_SESSION[ 'publishentrydata' ] = $obj->getpublishdata();
//		print_r($_SESSION[ 'publishentrydata' ]);
...
<nav id="navbar">
  ...
  <div id="nav-menu"> <a href="homepage.php">Home</a><a href="community.php">Community</a> <a class="<?php if ( isset( $_SESSION[ 'loggedIn' ] ) ) {echo" nodisplay"; } ?>" href="login">Login</a> <a class="navsignup <?php if ( isset( $_SESSION[ 'loggedIn' ] ) ) {echo" nodisplay"; } ?>" href="#contact">Topics</a>
    <?php
    if ( isset( $_SESSION[ 'loggedIn' ] ) ) {
...
//      echo '<div class="">Logged Out</div>';
  ...
  <section class="left-navigations">
    ...
    <a href="homepage.php" ><i class="fa-solid fa-bars" ></i> My Topics</a> <a href="draft.php" ><i class="fa-solid fa-bookmark"></i> Drafts</a> <a href="publish.php" class="current"><i class="fa-solid fa-circle-check"></i> Published</a> <a href="users.php" class="<?php if ($usertype == 1 ) { echo ' nodisplay';} ?>"><i class="fa-solid fa-user-lock"></i> Users</a> </section>
    ...
    <div class="content">
      <div class="name2">
        <h1>Published Entries</h1>
		  <p>This is where you see all your published entries</p>
      </div>
...
//        			exit();
        ...
        foreach ( $_SESSION[ 'publishentrydata' ] as $result1 ) {
          ...
          //		  <div><p class="bgname2">' . $result1[ 'bgname' ] . '</p></div>
          if ( $result1[ 'userid' ] == $_SESSION[ 'userid' ] ) {
			...
			<div class="displayentrydetails">
			  <form action="controlroom.php"  method="post">
				...
				<input class="statustypeblue" value="' . $statustype[ 0 ][ 'statustype' ] . '">
			  </form>
			  <form action="controlroom.php" method="post">
				<input type="hidden" name="blogid" value="' . $result1[ 'blogid' ] . '">
				<input type="hidden" name="entryid" value="' . $result1[ 'entryid' ] . '">
				<input title="edit this entry - this allows you to put the source in as a hover effect" type="image" src="images/edit.png" name="editpublish" class="editentry" value="Edit">
			  </form>
			  <form action="controlroom.php" method="post">
				<input type="hidden" name="blogid" value="' . $result1[ 'blogid' ] . '">
				<input type="hidden" name="entryid" value="' . $result1[ 'entryid' ] . '">
				<input title="delete this entry - icon hapus PNG image with transparent background@toppng.com" type="image" src="images/delete-16.png" name="deletepublish" value="Delete">
			  </form>
			  <form action="controlroom.php" method="post">
				<input type="hidden" name="entryid" value="' . $result1[ 'entryid' ] . '">
				<input type="hidden" name="blogid" value="' . $result1[ 'blogid' ] . '">
				<input class="btn" id="submit" name="previewpublish" type="submit" value="Preview">
			  </form>
			</div> ';
									  ...
									  <div class="deletingblogcontent">
										  <div>
											  <form action="controlroom.php" method="post" autocomplete="off">
												...
												<div class="doublebuttons">
												<button class="btn4" id="submit" type="submit" name="deletepublishentry">Confirm delete</button>
												<button class="btn" type="submit" name="pcanceldeleteentry">No, cancel</button>
												</div>
											   </form>
										   </div>
										</div>
